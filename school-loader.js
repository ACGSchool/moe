fetch("schools.json?" + String(Date.parse(new Date()))).then(res => {
    ...
    thead.innerHTML = `<tr><th scope="col" style="min-width: 170px;">学校名</th><th scope="col" style="min-width: 30px;">成立时间</th><th scope="col" style="min-width: 270px;">申请条件</th><th scope="col" style="min-width: 170px;">学校类型</th><th scope="col">网站</th><th scope="col" style="min-width: 70px;">受验需求</th></tr>`;
